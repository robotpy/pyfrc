...
class PhysicsInterface:
    ...
    def _create_and_attach(
        ...
        if physics_module_path.exists():
            ...
            return PhysicsInterface(robot_class, physics_module)
    ...
    def __init__(self, robot_class, physics_module):

        robot_class._simulationInit = self._simulationInit
        robot_class._simulationPeriodic = self._simulationPeriodic
